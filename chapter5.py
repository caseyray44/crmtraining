...
**What’s Next?**  
In the next module, we’ll learn about the commission for existing customers, which uses a different process since Markate doesn’t track it automatically. Let’s make sure you understand the process for new sales with a quick quiz!
""",
        "task_type": "miniquiz",
        "miniquiz_questions": [
            {
...
If you don’t submit the work order sheet, you won’t get your commission, even if you booked the job—because how is the office supposed to know? Make it a habit to fill out and submit the sheet right after creating the work orders in Markate.

**What’s Next?**  
In the next module, we’ll learn about hourly rates for tasks outside the scope of sales, which use a similar tracking process. Let’s make sure you understand the process for existing customers with a quick quiz!
""",
        "task_type": "miniquiz",
        "miniquiz_questions": [
            {
...
Great work so far! You’ve learned how to earn your commissions on new sales and existing customers—now let’s talk about another way you might earn money at CC Inc.: hourly rates for field work. I’ll explain how this works, how to track it, and how it fits into the payroll process. Let’s get started!

**What Are Hourly Rates at CC Inc.?**  
At CC Inc., your main earnings come from commissions, but you might also do work in the field that’s paid at a flat hourly rate. This hourly rate is for tasks outside the scope of sales—things that aren’t related to booking jobs, since those are covered by your commissions. For example:  
...
Tracking your hourly work uses the same work order sheet process you learned for commissions on existing customers. Here’s how it works:  
...
- Submit the work order sheet. Place the sheet in the work order bins in the shop, just like you do for commissions on existing customers.  

**How Hourly Pay Gets Processed**  
Your hourly pay follows the same payroll process as your commissions on existing customers, which we’ll cover in more detail in the next module. For now, know that your sheet stays in the work order bins until the biweekly payroll period ends. The payroll team will collect it, process your pay, and move the sheet to the outbound files for you to review.
...
- Commission on new sales. This is tracked automatically in Markate when you send the estimate and the customer accepts it.  
- Commission on existing customers. This is tracked manually by submitting a work order sheet to the bins in the shop.  
- Hourly rates for field work. This is also tracked manually by submitting a work order sheet for tasks outside the scope of sales.  
...
At CC Inc., we process payroll biweekly—that means you get paid every two weeks. Your commissions and any other earnings (like hourly rates) are included in your biweekly paycheck. The payroll process makes sure all your hard work is tracked and paid accurately.
...
- Get your paycheck. Every two weeks, you’ll get a paycheck that includes:  
  - Your commissions from new sales (tracked by Markate).  
  - Your commissions from existing customer sales (from your work order sheets).  
...
- You booked $8,000 in new sales, earning a commission of $800.  
- You booked $1,350 with an existing customer, John Doe, earning a commission of $67.50.  
- You worked 3 hours in the field at $20 per hour, earning $60.  
