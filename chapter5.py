...
1. **Log Into Your Markate Account:** Every sales rep at CC Inc. has their own login for Markate. This is *not* the staging environment you used in Chapter 1, Module 2—this is your personal account for real customer work. Make sure you’re logged in with your personal account—not someone else’s!  
...
4. **Markate Tracks Your Commission:** Once the job is accepted by the customer, Markate automatically calculates your 10% commission and adds it to your payroll. You’ll see this on your biweekly pay statement (we’ll cover payroll in a later module).  
...
- Markate logs that you sent the estimate from your account and calculates your commission: $80 (10% of $800).  
...
An *existing customer* is someone who has worked with CC Inc. before—they already have a customer account in Markate, and they might have past invoices or estimates, which could be 3–4 years old. As long as they’re an existing customer, you earn a 5% commission on any new jobs you book with them. For example:  
...
If you don’t submit the work order sheet, you won’t get your 5% commission, even if you booked the job—because how is the office supposed to know? Make it a habit to fill out and submit the sheet right after creating the work orders in Markate.

**What’s Next?**  
In the next module, we’ll learn about hourly rates for tasks outside the scope of sales, which use a similar tracking process. Let’s make sure you understand the 5% commission process with a quick quiz!
""",
        "task_type": "miniquiz",
        "miniquiz_questions": [
            {
...
Great work so far! You’ve learned how to earn your 10% and 5% commissions—now let’s talk about another way you might earn money at CC Inc.: *hourly rates* for field work. I’ll explain how this works, how to track it, and how it fits into the payroll process. Let’s get started!

**What Are Hourly Rates at CC Inc.?**  
At CC Inc., your main earnings come from commissions (10% for new sales, 5% for existing customers), but you might also do work in the field that’s paid at a flat hourly rate. This hourly rate is for tasks *outside the scope of sales*—things that aren’t related to booking jobs, since those are covered by your commissions. For example:  
...
- **Submit the Work Order Sheet:** Place the sheet in the *work order bins* in the shop, just like you do for 5% commissions.  

**How Hourly Pay Gets Processed**  
Your hourly pay follows the same payroll process as your 5% commissions, which we’ll cover in more detail in the next module. For now, know that your sheet stays in the work order bins until the biweekly payroll period ends. The payroll team will collect it, process your pay, and move the sheet to the *outbound files* for you to review.

**Example: Combining Commissions and Hourly Pay**  
Let’s say in one pay period:  
- You earned $800 in 10% commissions from new sales.  
- You earned $450 in 5% commissions from an existing customer (John Doe).  
...
- **10% Commission on New Sales:** Tracked automatically in Markate when you send the estimate and the customer accepts it.  
- **5% Commission on Existing Customers:** Tracked manually by submitting a work order sheet to the bins in the shop.  
...
- **Existing Customer Sales (5% Commission) and Hourly Rates:**  
  ...
  - Here’s what happens next:  
    ...
    - **Step 2: Payroll Processing:** When the biweekly payroll period ends, the payroll team collects all sheets from the bins and moves them to the office. They calculate your 5% commission (e.g., $67.50 for John Doe’s $1,350 job) or your hourly pay (e.g., $60 for 3 hours at $20/hour) and add it to your paycheck.  
...
- You booked $8,000 in new sales (10% commission = $800).  
