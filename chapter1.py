...
- **They Need More Communication**: Businesses often have specific people we need to contact (like a facilities manager), and they might change their contact info once they realize notifications go to the main contact.  
...
3. **Set the Customer Type to “Commercial”**: At the top of the form, you’ll see the “Customer Type” dropdown menu. Click on it and select “Commercial.”  
   - **Why Commercial?** This tells Markate that we’re creating an account for a business, not an individual person. It changes the form slightly to include fields like “Company Name.”  
4. **Fill in the Required Information**: Now you’ll enter the business’s details. Since we’re in the staging environment, we’ll use fake information to practice.  
   - **Company Name**: Use a fake business name (e.g., Johnson Corp).  
   - **Contact Name**: The main person we talk to (e.g., Sarah Smith).  
   - **Email**: firstname@example.com.  
   - **Mobile Phone**: 555-XXXXXXX.  
   - **Preferred Notification Method**: Both Email & Text.  
   - **Billing Address**: The company’s main office address.  
5. **Add Service Addresses**: If they have multiple locations (like “Building A,” “Building B,” etc.), add each one as a separate Service Address.  
6. **Click “Save”**: The new commercial customer will appear in the list, ready for scheduling services.

**Practice**: Create 15 commercial customers. Each time, use a different fake business name, contact, and addresses. That’s it!
        """,
        "task_type": "scenario",
        "task": """
...
**What You’ll Do in This Module**  
You’ll create a test account for yourself in Markate’s staging environment, using your own name and a test address. This will be a residential customer account. By setting up this account, you’ll get a better understanding of how Markate works for customers, which will make you better at your job as a sales rep.

**Why Create a Test Account for Yourself?**  
- **See the Customer’s Experience**.  
- **Test Notifications** (in theory, since staging doesn’t send real texts).  
- **Build Empathy** for how the customer sees Markate.

**Steps to Create Your Test Account**  
1. Go to Sales → Customers.  
2. Click “+ New Customer,” choose Residential.  
3. Enter your name (or a fake variation), phone, and email (can be fake).  
4. Set Preferred Notification Method to Both Email & Text.  
5. Use a fake Billing Address.  
6. Click Save.

Now you can see yourself in the Customers list as if you were a real customer!
        """,
        "task_type": "reflection",
